...
public class HomeControllerTest {
    ...
    public void shouldProcessRegistration() throws Exception {
        ...
        Spitter unsaved = new Spitter("mackie","mack1912","mack","bruno");
        Spitter saved = new Spitter(24L,"mackie","mack1912","mack","bruno");

        when(mockRepository.save(unsaved)).thenReturn(saved);
        SpitterController controller = new SpitterController(mockRepository);
        MockMvc mockMvc = standaloneSetup(controller).build();
        mockMvc.perform(post("/spitter/register")
                .param("username","mackie")
                .param("password","mack1912")
                .param("firstName", "mack")
                .param("lastName", "bruno"))
                .andExpect(redirectedUrl("/spitter/mackie"));
